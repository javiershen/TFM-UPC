...
const (
	mspID         = "Org1MSP"
	cryptoPath    = "../../test-network/organizations/peerOrganizations/org1.pharma.com"
	certPath      = cryptoPath + "/users/User1@org1.pharma.com/msp/signcerts/cert.pem"
	keyPath       = cryptoPath + "/users/User1@org1.pharma.com/msp/keystore/"
	tlsCertPath   = cryptoPath + "/peers/peer0.org1.pharma.com/tls/ca.crt"
